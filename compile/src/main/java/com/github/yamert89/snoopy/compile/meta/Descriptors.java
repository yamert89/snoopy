package com.github.yamert89.snoopy.compile.meta;

public class Descriptors {
    public static final String REPLACE_SQL = "Lyamert89/snoopy/meta/InjectSQL;";
    public static final String REPLACE_SQL_FIELD = "Lyamert89/snoopy/meta/InjectSQLField;";
